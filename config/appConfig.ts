...
export const defaultAppConfig: AppConfig = {
  ...
  themes: [
    ...
    { id: 'sunset', name: 'Sunset', color: 'bg-gradient-to-br from-[#F59E0B] to-[#EF4444]', cssVar: '#F97316', pro: false },
    { id: 'midnight', name: 'Midnight', color: 'bg-gradient-to-br from-[#1E293B] to-[#0F172A]', cssVar: '#64748B', pro: false },
    { id: 'rose', name: 'Rose', color: 'bg-gradient-to-br from-[#E11D48] to-[#9F1239]', cssVar: '#E11D48', pro: false },
    { id: 'amber', name: 'Amber', color: 'bg-gradient-to-br from-[#D97706] to-[#92400E]', cssVar: '#D97706', pro: false },
    { id: 'arctic', name: 'Arctic', color: 'bg-gradient-to-br from-[#38BDF8] to-[#818CF8]', cssVar: '#38BDF8', pro: false },
    { id: 'forest', name: 'Forest', color: 'bg-gradient-to-br from-[#22C55E] to-[#15803D]', cssVar: '#22C55E', pro: false },
    { id: 'aurora', name: 'Aurora', color: 'bg-gradient-to-br from-[#34D399] to-[#6366F1]', cssVar: '#34D399', pro: false },
    { id: 'sakura', name: 'Sakura', color: 'bg-gradient-to-br from-[#F9A8D4] to-[#C084FC]', cssVar: '#F472B6', pro: false },
    { id: 'volcano', name: 'Volcano', color: 'bg-gradient-to-br from-[#FF6B35] to-[#C81D25]', cssVar: '#FF6B35', pro: false },
    { id: 'cyber', name: 'Cyber', color: 'bg-gradient-to-br from-[#00F5D4] to-[#7B2FF7]', cssVar: '#00F5D4', pro: false },
    { id: 'mocha', name: 'Mocha', color: 'bg-gradient-to-br from-[#A0845C] to-[#5C4033]', cssVar: '#A0845C', pro: false },
    { id: 'nord', name: 'Nord', color: 'bg-gradient-to-br from-[#88C0D0] to-[#5E81AC]', cssVar: '#88C0D0', pro: false },
    { id: 'lavender', name: 'Lavender', color: 'bg-gradient-to-br from-[#A78BFA] to-[#7C3AED]', cssVar: '#A78BFA', pro: false },
    { id: 'mint', name: 'Mint', color: 'bg-gradient-to-br from-[#6EE7B7] to-[#34D399]', cssVar: '#6EE7B7', pro: false },
    { id: 'candy', name: 'Candy', color: 'bg-gradient-to-br from-[#F472B6] to-[#EC4899]', cssVar: '#F472B6', pro: false },
    { id: 'steel', name: 'Steel', color: 'bg-gradient-to-br from-[#94A3B8] to-[#64748B]', cssVar: '#94A3B8', pro: false },
    { id: 'gold', name: 'Gold', color: 'bg-gradient-to-br from-[#FCD34D] to-[#F59E0B]', cssVar: '#FCD34D', pro: false },
    { id: 'neon', name: 'Neon', color: 'bg-gradient-to-br from-[#84CC16] to-[#22C55E]', cssVar: '#84CC16', pro: false },
    { id: 'grape', name: 'Grape', color: 'bg-gradient-to-br from-[#A855F7] to-[#7E22CE]', cssVar: '#A855F7', pro: false },
  ],
